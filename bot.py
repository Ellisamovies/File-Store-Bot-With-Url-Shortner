    ...
    if usr_cmd == "/start":
        ...
        await cmd.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("Updates Channel", url="https://t.me/ellisa_world")
                    ],
                    [
                    ...
                    [
                        ...
                        InlineKeyboardButton("YouTube Channel", url="https://youtube.com/@ELLISA_india")
                    ]
                ]
            )
        )
...
async def main(bot: Client, message: Message):
    ...
    if message.chat.type == enums.ChatType.PRIVATE:
        ...
        if message.from_user.id in Config.BANNED_USERS:
            await message.reply_text("Sorry, You are banned!\n\nContact [𝙎𝙪𝙥𝙥𝙤𝙧𝙩 𝙂𝙧𝙤𝙪𝙥](https://t.me/ellisa_support_group)",
                                     disable_web_page_preview=True)
            return
                ...
                [
                    [
                        InlineKeyboardButton("Source Codes of Bot",
                                             url="https://youtube.com/@ELLISA_india")
                    ],
                    [
        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                if user.status == "kicked":
                    await cmd.message.edit(
                        text="Sorry Sir, You are Banned to use me. Contact my [𝙎𝙪𝙥𝙥𝙤𝙧𝙩 𝙂𝙧𝙤𝙪𝙥](https://t.me/ellisa_support_group).",
                        disable_web_page_preview=True
                    )
                    return
                ...
                await cmd.message.edit(
                    text="Something went Wrong. Contact my [𝙎𝙪𝙥𝙥𝙤𝙧𝙩 𝙂𝙧𝙤𝙪𝙥](https://t.me/ellisa_support_group).",
                    disable_web_page_preview=True
                )
                return
        await cmd.message.edit(
